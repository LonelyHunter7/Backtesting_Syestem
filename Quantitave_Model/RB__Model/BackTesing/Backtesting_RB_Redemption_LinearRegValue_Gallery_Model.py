...
#首先添加需要的地址方便进行模块引用
import sys
sys.path.append(r"E:\MAIZIPYTHON\Quantitave_Strategy_Model\Quantitave_Model\RB_Model\BackTesting")
...
from RB_Redemption_LinearRegValue_Gallery_Model import RB_R_L_G_M_Strategy
