...
#         print(tradeData)
    ...
    #----------------------------------------------------------------------
    def sendOrder(self, instrumentid, exchangeid, price, pricetype, volume, direction, offset,time):
        """回测发单"""
    ...
    def saveTradeData(self):
        """保存交易记录,存入到csv文件中，然后后期再进行处理"""
        with open('E:/test.csv',"w") as f:
            writer=csv.writer(f,delimiter=",")
            for data in self.listTrade:
